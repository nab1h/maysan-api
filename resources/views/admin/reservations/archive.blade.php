    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    <h3 class="text-2xl font-bold text-gray-900">سجل الحجوزات المؤرشفة</h3>
                    <p class="text-gray-500 text-sm mt-1">عرض الحجوزات المؤرشفة (المنتهية أو المحذوفة مؤقتاً).</p>
                </div>
                ...
                <div class="flex gap-3 items-center flex-wrap">
                    ...
                    <form action="{{ route('reservations.archive') }}" method="GET" class="flex gap-3 items-center">
                        ...
                        <button type="submit" class="bg-white text-gray-600 hover:text-[#135158] px-3 py-2.5 rounded-lg border border-gray-300 hover:border-[#135158] transition">
                    ...
                    <a href="{{ route('reservations.index') }}">
                        <button class="px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg transition flex items-center gap-2 border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                    <p class="text-gray-500 text-xs">إجمالي المؤرشف</p>
                    <h4 class="text-xl text-gray-900 font-bold mt-1">{{ $totalArchived ?? 0 }}</h4>
                </div>

                <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center justify-center">
                    ...
                    <table class="w-full text-sm text-gray-700">
                        <thead class="bg-gray-50 text-gray-500 text-xs uppercase border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-4 py-4 text-start">الحالة</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-100 hover:bg-gray-50/50 transition duration-200">
                                ...
                                <td class="px-4 py-4">
                                    ...
                                    'cancelled' => 'bg-[#135158]/10 text-[#135158] border border-[#135158]/20',
                                ...
                                <td class="px-4 py-4 text-center">
                                    <div class="flex justify-center gap-3 items-center flex-wrap">
                                        ...
                                        <form action="{{ route('reservations.restore', $reservation->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit" class="w-8 h-8 rounded-full bg-green-50 flex items-center justify-center text-green-600 hover:bg-green-600 hover:text-white transition border border-green-100 hover:border-green-600" title="استعادة الحجز">
                                        ...
                                        <form action="{{ route('reservations.destroy', $reservation->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button class="w-8 h-8 rounded-full bg-[#135158]/10 flex items-center justify-center text-[#135158] hover:bg-[#135158] hover:text-white transition border border-[#135158]/20 hover:border-[#135158]"
                                                title="حذف نهائي"
