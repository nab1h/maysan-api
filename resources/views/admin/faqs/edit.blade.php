            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
                <form action="{{ route('admin.faqs.update', $faq) }}" method="POST">
                    ...
                    <div class="mb-8 border-b border-gray-200 pb-6">
                        ...
                        <p class="text-gray-600 text-sm">قم بتعديل السؤال والإجابة والقسم المرتبط به أو حالة الظهور.</p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <select name="department_id" id="department_id" required
                            ...
                            <option value="{{ $dept->id }}" {{ old('department_id', $faq->department_id) == $dept->id ? 'selected' : '' }}>{{ $dept->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="answer_ar" rows="5" required
                            class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#135158]/20 focus:border-[#135158] transition resize-y" dir="rtl">{{ old('answer_ar', $faq->answer_ar) }}</textarea>
                    </div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl border border-gray-200 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="order_column" value="{{ old('order_column', $faq->order_column) }}"
                            ...
                            <div class="flex items-center mt-6 pt-2 md:pt-0">
                                <!-- حقل مخفي عشان يبعت 0 لما الـ checkbox يكون فاضي -->
