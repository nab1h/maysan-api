<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-900 leading-tight">إضافة فيديو جديد</h2>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
                <form action="{{ route('admin.reels.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-xs text-gray-400 mt-2">تأكدي من نسخ رابط الفيديو من الانستجرام بالكامل</p>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-xs text-red-500 mt-2">* يمكنك إضافة الفيديوهات لفرعك فقط.</p>
                        @endif
                    </div>
